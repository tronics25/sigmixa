...
export type FrameEditorToExtension =
  | { readonly type: 'ready' }
  | { readonly type: 'save'; readonly frame: ManualFrameDefinition }
...
export type FrameEditorToWebview =
  ...
  | { readonly type: 'saveResult'; readonly saved: boolean; readonly diagnostics: readonly Diagnostic[]; readonly frame?: ManualFrameDefinition };
